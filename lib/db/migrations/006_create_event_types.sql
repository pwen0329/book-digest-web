...
CREATE TABLE IF NOT EXISTS event_types (
  code VARCHAR(50) PRIMARY KEY,  -- e.g., 'MANDARIN_BOOK_CLUB', 'ENGLISH_BOOK_CLUB', 'DETOX', 'FAMILY_READING_CLUB'
  name_en VARCHAR(100) NOT NULL, -- English name
  name_zh VARCHAR(100) NOT NULL  -- Mandarin/Chinese name
);

-- Insert default event types (updated to split BOOK_CLUB into language-specific types)
